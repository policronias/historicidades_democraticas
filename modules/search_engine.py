...
class SearchEngine:
    ...
    def highlight_term(
        ...
        for start, end in sorted(posicoes):
            ...
            resultado_parts.append(f'<mark style="background-color: {cor}; color: #1b1815; padding: 2px 4px;">{match_text}</mark>')
            idx_atual = end
    ...
    def highlight_multiple_terms(
        ...
        for start, end, cor, original_text in todas_posicoes:
            ...
            resultado_parts.append(f'<mark style="background-color: {cor}; color: #1b1815; padding: 2px 4px;">{original_text}</mark>')
            idx_atual = end
